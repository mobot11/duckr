...
export function ducks(state = initialState, action) {
	switch (action.type) {
		case FETCHING_DUCK:
			return {
				...state,
...
export function likeCount(state = initialState, action) {
	switch (action.type) {
		case FETCHING_COUNT:
			return {
				...state,
...
export function usersDucks(state = initialState, action) {
	switch (action.type) {
...
export function usersLikes(state = initialState, action) {
